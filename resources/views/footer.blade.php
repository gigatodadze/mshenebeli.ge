...
{{--            </div>--}}
            ...
            <div class="col-lg-12 col-md-12">
                ...
                <address>
                        <p>@lang('footer.address') :&nbsp <a href="https://www.google.com/maps/@41.7453148,44.7738537,18.9z" data-fancybox data-width="640" data-height="360">@lang('footer.alio mirtskhulava str. 9/11') </a></p>
                    <p>@lang('footer.contact us') :&nbsp <a href="tel:(+995) 558 348 000">(+995) 558 348 000</a></p>
                    <p>@lang('footer.message us') :&nbsp <a href="mailto:info@mshenebeli.ge">info@mshenebeli.ge</a><br></p>
                </address>
            </div>
            <!-- end col-4 -->
{{--            <div class="col-lg-4">--}}
